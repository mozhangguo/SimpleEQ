...
struct Fifo {
    void prepare (int numChannels, int numSamples) {
        static_assert (std::is_same_v<T, juce::AudioBuffer<float>>, "prepare channels and samples should only be used when the fifo is holding juce::audioBuffer<float>");
    ...
    void prepare(size_t numElements) {
        static_assert(std::is_same_v<T, std::vector<float>>, "prepare num elements should only be used when the Fifo is holding std::vector<float>");
...
public:
    ...
    static juce::AudioProcessorValueTreeState::ParameterLayout createParamemterLayout();
    
    juce::AudioProcessorValueTreeState apvts {*this, nullptr, "Paramemters", createParamemterLayout()};
